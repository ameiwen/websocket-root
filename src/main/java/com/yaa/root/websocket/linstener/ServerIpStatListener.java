 ...
 * 
 */
package com.yaa.root.websocket.linstener;
...
public class ServerIpStatListener implements IpStatListener {

	private static Logger log = LoggerFactory.getLogger(ServerIpStatListener.class);

	public static final ServerIpStatListener me = new ServerIpStatListener();

	/**
	 *
	 */
	private ServerIpStatListener() {
	}
